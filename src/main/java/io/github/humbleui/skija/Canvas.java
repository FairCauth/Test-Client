...
public class Canvas extends Managed {
    ...
    public Canvas drawRect(@NotNull Rect r, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawRect(_ptr, r._left, r._top, r._right, r._bottom, getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawOval(@NotNull Rect r, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawOval(_ptr, r._left, r._top, r._right, r._bottom, getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawRRect(@NotNull RRect r, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawRRect(_ptr, r._left, r._top, r._right, r._bottom, r._radii, getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public boolean quickReject(@NotNull Path path) {
        try {
            ...
            Stats.onNativeCall();
            return _nQuickRejectPath(_ptr, getPtr(path));
        } finally {
            ReferenceUtil.reachabilityFence(this);
    ...
    public Canvas drawDRRect(@NotNull RRect outer, @NotNull RRect inner, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawDRRect(_ptr, outer._left, outer._top, outer._right, outer._bottom, outer._radii, inner._left, inner._top, inner._right, inner._bottom, inner._radii, getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawImageRect(@NotNull Image image, @NotNull Rect src, @NotNull Rect dst, @NotNull SamplingMode samplingMode, @Nullable Paint paint, boolean strict) {
        ...
        Stats.onNativeCall();
        _nDrawImageRect(_ptr, getPtr(image), src._left, src._top, src._right, src._bottom, dst._left, dst._top, dst._right, dst._bottom, samplingMode._pack(), getPtr(paint), strict);
    ...
    public Canvas drawImageNine(@NotNull Image image, @NotNull IRect center, @NotNull Rect dst, @NotNull FilterMode filterMode, @Nullable Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawImageNine(_ptr, getPtr(image), center._left, center._top, center._right, center._bottom, dst._left, dst._top, dst._right, dst._bottom, filterMode.ordinal(), getPtr(paint));
        ReferenceUtil.reachabilityFence(image);
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawPicture(@NotNull Picture picture, @Nullable Matrix33 matrix, @Nullable Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawPicture(_ptr, getPtr(picture), matrix == null ? null : matrix._mat, getPtr(paint));
    ...
    public Canvas drawTriangles(@NotNull Point[] positions, @Nullable int[] colors, @Nullable Point[] texCoords, @Nullable short[] indices, @NotNull BlendMode mode, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawVertices(_ptr, 0 /* kTriangles_VertexMode */, Point.flattenArray(positions), colors, Point.flattenArray(texCoords), indices, mode.ordinal(), getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawTriangleStrip(@NotNull Point[] positions, @Nullable int[] colors, @Nullable Point[] texCoords, @Nullable short[] indices, @NotNull BlendMode mode, @NotNull Paint paint) {
        ...
        assert paint != null : "Can’t drawTriangles with paint == null";
        Stats.onNativeCall();
        _nDrawVertices(_ptr, 1 /* kTriangleStrip_VertexMode */, Point.flattenArray(positions), colors, Point.flattenArray(texCoords), indices, mode.ordinal(), getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawTriangleFan(@NotNull Point[] positions, @Nullable int[] colors, @Nullable Point[] texCoords, @Nullable short[] indices, @NotNull BlendMode mode, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawVertices(_ptr, 2 /* kTriangleFan_VertexMode */, Point.flattenArray(positions), colors, Point.flattenArray(texCoords), indices, mode.ordinal(), getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawPatch(@NotNull Point[] cubics, @NotNull int[] colors, @Nullable Point[] texCoords, @NotNull BlendMode mode, @NotNull Paint paint) {
        ...
        Stats.onNativeCall();
        _nDrawPatch(_ptr, Point.flattenArray(cubics), colors, Point.flattenArray(texCoords), mode.ordinal(), getPtr(paint));
        ReferenceUtil.reachabilityFence(paint);
        return this;
    }
    ...
    public Canvas drawDrawable(@NotNull Drawable drawable, @Nullable Matrix33 matrix) {
        ...
        Stats.onNativeCall();
        _nDrawDrawable(_ptr, getPtr(drawable), matrix == null ? null : matrix._mat);
    ...
    public boolean readPixels(@NotNull Bitmap bitmap, int srcX, int srcY) {
        try {
            ...
            Stats.onNativeCall();
            return _nReadPixels(_ptr, getPtr(bitmap), srcX, srcY);
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(bitmap);
        }
    ...
    */
    public boolean writePixels(@NotNull Bitmap bitmap, int x, int y) {
        try {
            ...
            Stats.onNativeCall();
            return _nWritePixels(_ptr, getPtr(bitmap), x, y);
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(bitmap);
        }
    ...
    public int saveLayer(float left, float top, float right, float bottom, @Nullable Paint paint) {
        try {
            assert _ptr != 0 : "Canvas is closed";
            Stats.onNativeCall();
            return _nSaveLayerRect(_ptr, left, top, right, bottom, getPtr(paint));
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(paint);
        }
    ...
    */
    public int saveLayer(@Nullable Rect bounds, @Nullable Paint paint) {
        try {
            ...
            Stats.onNativeCall();
            if (bounds == null)
                return _nSaveLayer(_ptr, getPtr(paint));
            else
                return _nSaveLayerRect(_ptr, bounds._left, bounds._top, bounds._right, bounds._bottom, getPtr(paint));
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(paint);
        }
    ...
    public int saveLayer(@NotNull SaveLayerRec layerRec) {
        try {
            ...
            if (bounds == null)
                return _nSaveLayerRec(_ptr, getPtr(layerRec._paint), getPtr(layerRec._backdrop), layerRec._flags);
            else
                return _nSaveLayerRecRect(_ptr, bounds._left, bounds._top, bounds._right, bounds._bottom, getPtr(layerRec._paint), getPtr(layerRec._backdrop), layerRec._flags);
        } finally {
            ReferenceUtil.reachabilityFence(this);
