...
public class Font extends Managed {
    ...
    public Font(@Nullable Typeface typeface) {
        this(_nMakeTypeface(getPtr(typeface)));
        Stats.onNativeCall();
    ...
    public Font(@Nullable Typeface typeface, float size) {
        this(_nMakeTypefaceSize(getPtr(typeface), size));
        Stats.onNativeCall();
        ReferenceUtil.reachabilityFence(typeface);
    }
    ...
    public Font(@Nullable Typeface typeface, float size, float scaleX, float skewX) {
        this(_nMakeTypefaceSizeScaleSkew(getPtr(typeface), size, scaleX, skewX));
        Stats.onNativeCall();
        ReferenceUtil.reachabilityFence(typeface);
    }
    ...
    */
    ...
    public Font setTypeface(@Nullable Typeface typeface) {
        try {
            _resetMetrics();
            Stats.onNativeCall();
            _nSetTypeface(_ptr, getPtr(typeface));
            return this;
        } finally {
            ReferenceUtil.reachabilityFence(typeface);
        }
    ...
    public Rect measureText(String s, Paint p) {
        try {
            Stats.onNativeCall();
            return _nMeasureText(_ptr, s, getPtr(p));
        } finally {
            ReferenceUtil.reachabilityFence(this);
    ...
    public float measureTextWidth(String s, Paint p) {
        try {
            Stats.onNativeCall();
            return _nMeasureTextWidth(_ptr, s, getPtr(p));
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(p);
        }
    ...
    public Rect[] getBounds(short[] glyphs, Paint p) {
        try {
            Stats.onNativeCall();
            return _nGetBounds(_ptr, glyphs, getPtr(p));
        } finally {
            ReferenceUtil.reachabilityFence(this);
            ReferenceUtil.reachabilityFence(p);
        }
