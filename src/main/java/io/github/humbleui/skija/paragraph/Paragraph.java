...
public class Paragraph extends Managed {
    ...
    public LineMetrics[] getLineMetrics() {
        try {
            ...
            Stats.onNativeCall();
            return _nGetLineMetrics(_ptr, getPtr(_text));
        } finally {
            ReferenceUtil.reachabilityFence(this);
    ...
    public Paragraph updateFontSize(int from, int to, float size) {
        try {
            if (_text != null) {
                Stats.onNativeCall();
                _nUpdateFontSize(_ptr, from, to, size, getPtr(_text));
            }
            return this;
        } finally {
            ReferenceUtil.reachabilityFence(_text);
    ...
    public Paragraph updateForegroundPaint(int from, int to, Paint paint) {
        try {
            if (_text != null) {
                Stats.onNativeCall();
                _nUpdateForegroundPaint(_ptr, from, to, getPtr(paint), getPtr(_text));
            }
            return this;
        } finally {
    ...
    public Paragraph updateBackgroundPaint(int from, int to, Paint paint) {
        try {
            if (_text != null) {
                Stats.onNativeCall();
                _nUpdateBackgroundPaint(_ptr, from, to, getPtr(paint), getPtr(_text));
            }
            return this;
        } finally {
            ReferenceUtil.reachabilityFence(paint);
